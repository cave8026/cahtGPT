...
<%@ page import="java.util.List,com.pet.dao.MediRecordDAO,com.pet.dto.MediRecordDTO" %>
<%--
  medilist.jsp
...
%>
  <p>Pet ID: <strong><%= petId %></strong> | <a href="mediadd.jsp?petId=<%=petId%>">새 기록 추가</a> | <a href="index.jsp">홈</a></p>
  <table>
    <thead>
